...
from mlmsite.models import MasterUser, User
...
class Tests(TestCase):
    ...
    def testCreateNewPositionForUser(self):
        ...
        self.assertEqual(master.active_position.left, newPosition)
        self.assertEqual(newPosition.top, master.active_position)
    ...
    def testHandleFullMatrixOfMaster(self):
        ...
        self.assertEqual(master.active_position.top, None)
    ...
    def testHandleFullMatrixOfUser(self):
        ...
        self.assertEqual(topUser.active_position.top.owner.id, master.id)
        self.assertTrue(master.active_position.right)
        self.assertEqual(master.active_position.right.id, topUser.active_position.id)
